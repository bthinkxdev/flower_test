...
AR: dict[str, str] = {
    ...
    "No more stock available.": "لا يتوفر المزيد من المخزون.",
    "Breadcrumb": "مسار التنقل",
    "Confirming Payment": "جارٍ تأكيد الدفع",
    "Only %(stock)s in stock": "%(stock)s فقط في المخزون",
    "Credit / Debit Card": "بطاقة ائتمان / خصم",
    "Qatar Local Payment": "الدفع المحلي في قطر",
    "Gift Voucher": "قسيمة هدية",
    "Cash on Delivery": "الدفع عند الاستلام",
    "Fawran": "فوران",
    "Fawran Number: 240803": "رقم فوران: 240803",
    "Card payment via POS machine also available on delivery": "يتوفر أيضاً الدفع بالبطاقة عبر جهاز نقاط البيع عند التسليم",
