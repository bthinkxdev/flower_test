...
TAP_API_BASE_URL = env("TAP_API_BASE_URL", default="https://api.tap.company/v2")
TAP_WEBHOOK_URL = env("TAP_WEBHOOK_URL", default="")
TAP_DEFAULT_SOURCE_ID = env("TAP_DEFAULT_SOURCE_ID", default="src_all")
TAP_DEFAULT_REDIRECT_URL = env("TAP_DEFAULT_REDIRECT_URL", default="")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="Floward <no-reply@floward.com>")