...
class HomepageSectionType(models.TextChoices):
    ...
    SHOP_BY_OCCASION = "shop_by_occasion", "Shop by Occasion"
    SHOP_BY_RECIPIENT = "shop_by_recipient", "Shop by Recipient"
    ...
    SAME_DAY_DELIVERY = "same_day_delivery", "Same Day Delivery"
    TRENDING = "trending", "Trending"
    BEST_SELLERS = "best_sellers", "Best Sellers"
    FEATURED_BRANDS = "featured_brands", "Featured Brands"
    CORPORATE_GIFTS_BANNER = "corporate_gifts_banner", "Corporate Gifts Banner"
